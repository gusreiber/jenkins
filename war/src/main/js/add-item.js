...
$.when(getItems()).done(function(data){
  $(function() {
    ...
    function drawItem(elem){
      ...
      var $item = $([
          '<li class="item-box ',cleanClassName(elem.class),'"><label><input name="mode" tabindex="0" value="',elem.class,'" type="radio" /> <span class="label">', elem.displayName, '</span></label></li>'
      ].join('')).append([
